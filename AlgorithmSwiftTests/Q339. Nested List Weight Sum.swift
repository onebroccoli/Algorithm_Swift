...
/*
input is nested. recursive
go through the list one by one, keeping track of the current depth d.
if a nested integer is an integer n, calculate its sum as n * d
if nested integer is a list, calculate the sum of this list recursively using the same process but with depth = d + 1
